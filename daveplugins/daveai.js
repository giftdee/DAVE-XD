...
zokou({nomCom:"davlo",reaction:"🤷",categorie:"DAVE-IA"},async(dest,zk,commandeOptions)=>{
...
.catch(error => {
  ...
  zokou({ nomCom: "bing4", reaction: "🌀", categorie: "DAVE-IA" }, async (dest, zk, commandeOptions) => {
    ...
    try {
      ...
      let caption = '*bing images by Gifted Dave*';
  ...
  zokou({ nomCom: "ai2", reaction: "🌀", categorie: "DAVE-IA" }, async (dest, zk, commandeOptions) => {
    const { repondre, arg, ms } = commandeOptions;
...
zokou({ nomCom: "gpt-all", reaction: "🌀", categorie: "DAVE-IA" }, async (dest, zk, commandeOptions) => {
    const { repondre, arg, ms } = commandeOptions;
