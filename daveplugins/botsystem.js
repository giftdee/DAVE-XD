...
async function loading(dest, zk) {
  ...
  "▰▰▰▰▰▰▰▰▱▱ 80%",
  "▰▰▰▰▰▰▰▰▰▰ 100%",
  "*⚡ 𝙇𝙤𝙖𝙙𝙞𝙣𝙜 𝙋𝙞𝙣𝙜... 𝐃𝐀𝐕𝐄-𝐗𝐌𝐃 𝙎𝙪𝙥𝙚𝙧 𝙎𝙥𝙚𝙚𝙙 ⚡*"
  ];
  ...
  async function redeployApp() {
    try {
      const response = await axios.post(
        ...
        {
          source_blob: {
            url: "ttps://github.com/giftdee/DAVE-XMD/tarball/main",
          },
        },
        {
          headers: {
      ...
      await repondre("*Your bot is getting updated, hold tight.*");
