...
ezra({
  ...
  _0x5d581a("✅ LUCKY XFORCE ANTI_TAG mode is now: " + _0x5f2161);
});
ezra({
  ...
  _0x1eb30c("✅ LUCKY XFORCE ANTI_MENTION_GROUP is now: *" + _0x3e7838.toUpperCase() + '*');
});
ezra({
  'nomCom': "antishare",
  'categorie': "Fredi-Settings",
  ...
  _0x5935f0("✅ LUCKY XFORCE ANTI_SHARE_GROUP is now: *" + _0x387fc4.toUpperCase() + '*');
});