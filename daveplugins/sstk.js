...
zokou({ nomCom: "url", categorie: "Dave-General", reaction: "👨🏿‍💻" }, async (origineMessage, zk, commandeOptions) => {
...
zokou({nomCom:"tophoto",categorie: "Dave-Sticker", reaction: "👨🏿‍💻"},async(dest,zk,commandeOptions)=>{
   const {ms , msgRepondu,arg,repondre,nomAuteurMessage} = commandeOptions ;
