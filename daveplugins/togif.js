...
zokou({
    ...
    try {
        ...
        const { data: commitData } = await axios.get("https://api.github.com/repos/giftdee/DAVE-XMD/commits/main");
        ...
        if (latestCommitHash === currentHash) {
            return reply("𝐃𝐀𝐕𝐄-𝐗𝐌𝐃 bot is already up-to-date!");
        }

        await reply("🗿 Updating 𝐃𝐀𝐕𝐄-𝐗𝐌𝐃  Bot...");

        // Download the latest code
        const zipPath = path.join(__dirname, "latest.zip");
        const { data: zipData } = await axios.get("https://github.com/giftdee/DAVE-XMD/archive/main.zip", { responseType: "arraybuffer" });
