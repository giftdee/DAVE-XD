...
zokou({
  ...
  try {
    ...
    const cap = `*Screenshot taken by 𝐃𝐀𝐕𝐄-𝐗𝐌𝐃*`;
...
zokou({
  ...
  try {
    // Caption for the screenshot
    const cap = `*Screenshot take by 𝐃𝐀𝐕𝐄-𝐗𝐌𝐃*`;
